...
class General extends PureComponent {
  ...
  componentWillMount = () => {
    console.log('General will mount');
  }
  ...
  componentWillReceiveProps = (nextProps) => {
    console.log('General will receive props', nextProps);
  }

  componentWillUpdate = (nextProps, nextState) => {
    console.log('General will update', nextProps, nextState);
  }

  componentDidUpdate = () => {
    console.log('General did update');
  }

  componentWillUnmount = () => {
    console.log('General will unmount');
  }
